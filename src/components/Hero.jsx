...
const Hero = () => {
  return (
    <>
    <div className=' grid w-full h-3/4  bg'>
      <div className='flex flex-col xl:flex-row gap-6 justify-center text-center items-center place-items-center px-2 mx-4'> 
        <h1 className=' text-left font-bold text-4xl 2xl:text-6xl xl:text-4xl leading-snug tracking-tight xl:relative xl:left-16 w-full'>
          Wallet recovery<br/> made easy with <br/> Ledger Recover</h1>
      ...
      <span className='place-self-center items-center font-normal text-[16px] leading-tight tracking-tighter border border-customBlack rounded mt-6 mb-20 p-1'>
        Service provided by Coincover</span>
    </div>
    </>
  )
}
