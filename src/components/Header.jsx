...
const Header = () => {
  ...
  return (
    <div onClick={handleRedirect} className='flex flex-col xl:flex-row gap-10px justify-center items-center font-sans font-semibold xl:text-[18px] w-full bg-Headercolor2 cursor-pointer'>
